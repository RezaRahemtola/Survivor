...
export async function runHttpRequestWithData<
  ResponseType = any,
  RequestDataType = any,
>(
  ...
  axiosConfiguration?: AxiosRequestConfig<RequestDataType>,
): Promise<ResponseType> {
  return axiosClient[method]<
    ResponseType,
    AxiosResponse<ResponseType>,
    RequestDataType
  >(url, data, axiosConfiguration)
    .then(({ data }) => data)
...
export async function runHttpRequest<ResponseType = any>(
  axiosClient: AxiosInstance,
  method: HttpMethod,
  url: string,
