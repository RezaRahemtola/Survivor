const translations = {
	user: {
		motd: {
			...
			placeholder: "Aucun message du jour pour le moment",
		},
		settings: {
			title: "Paramètres",
			reset: "Réinitialiser",
		...
		signIn: {
			...
			action: "Connexion",
			wrongCredentials: "Email et/ou mot de passe invalide, veuillez réessayer.",
		},
		gender: {
			male: "Homme",
			female: "Femme",
	...
	widgets: {
		...
		edition: {
			...
			noneAvailable: "Aucun widget disponible",
			edit: "Modifier",
		},
		selector: {
		...
		news: {
			loading: "Récupération des actualités...",
		},
		icelandCarpooling: {
